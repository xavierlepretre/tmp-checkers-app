...
func (x *StoredGame) slowProtoReflect() protoreflect.Message {
	mi := &file_checkersapp_checkers_stored_game_proto_msgTypes[0]
...
func (x *fastReflection_StoredGame) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "checkersapp.checkers.StoredGame.turn":
		return x.Turn != ""
	case "checkersapp.checkers.StoredGame.black":
		return x.Black != ""
	case "checkersapp.checkers.StoredGame.red":
		return x.Red != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: checkersapp.checkers.StoredGame"))
		}
		panic(fmt.Errorf("message checkersapp.checkers.StoredGame does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StoredGame) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message checkersapp.checkers.StoredGame does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StoredGame) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "checkersapp.checkers.StoredGame.turn":
		panic(fmt.Errorf("field turn of message checkersapp.checkers.StoredGame is not mutable"))
	case "checkersapp.checkers.StoredGame.black":
		panic(fmt.Errorf("field black of message checkersapp.checkers.StoredGame is not mutable"))
	case "checkersapp.checkers.StoredGame.red":
		panic(fmt.Errorf("field red of message checkersapp.checkers.StoredGame is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: checkersapp.checkers.StoredGame"))
		}
...
func (x *fastReflection_StoredGame) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in checkersapp.checkers.StoredGame", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	file_checkersapp_checkers_stored_game_proto_rawDescOnce sync.Once
	file_checkersapp_checkers_stored_game_proto_rawDescData = file_checkersapp_checkers_stored_game_proto_rawDesc
)

func file_checkersapp_checkers_stored_game_proto_rawDescGZIP() []byte {
	file_checkersapp_checkers_stored_game_proto_rawDescOnce.Do(func() {
		file_checkersapp_checkers_stored_game_proto_rawDescData = protoimpl.X.CompressGZIP(file_checkersapp_checkers_stored_game_proto_rawDescData)
	})
...
func file_checkersapp_checkers_stored_game_proto_init() {
	if File_checkersapp_checkers_stored_game_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_checkersapp_checkers_stored_game_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_checkersapp_checkers_stored_game_proto_goTypes,
		DependencyIndexes: file_checkersapp_checkers_stored_game_proto_depIdxs,
		MessageInfos:      file_checkersapp_checkers_stored_game_proto_msgTypes,
	}.Build()
	File_checkersapp_checkers_stored_game_proto = out.File
	file_checkersapp_checkers_stored_game_proto_rawDesc = nil
	file_checkersapp_checkers_stored_game_proto_goTypes = nil
	file_checkersapp_checkers_stored_game_proto_depIdxs = nil
}
